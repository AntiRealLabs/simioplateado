	    ...
	    'bicho-k': {
	      ...
	      alt: 'BICHO_K.v01'
		    ...
		    'sphinx-tenebrosa': {
		      ...
		      state: 'Gestándose · imprimiéndose',
		      ...
		      production: 'Estado: imprimiéndose. SKU PA-002. Línea Panteón Argenti · Volumen I. Foto de referencia cargada; falta confirmar GLB/STL, escala, precio y tirada antes de abrir compra.',
		      caption: 'Estudio visual / Panteón Argenti',
		      img: 'assets/optimized/processed/piezas/panteon-argenti/sphinx-tenebrosa-cutout.webp',
		      imageVersion: '20260629-panteon-argenti',
		      interestMode: 'have',
		      alt: 'SPHINX_TENEBROSA Panteon Argenti esfinge oscura sobre templo'
		    },
		    'geminae-doloris': {
  ...
  const PARTY_ANIMALS = {
    ...
    'corazon-capsula': {
      ...
      code: 'CORAZON_CAPSULA.v01',
      title: 'CORAZON_CAPSULA.v01',
      stateKey: 'state.visualOnly',
      actionTitle: 'Corazon Capsula',
      series: 'Objetos · órgano en vitrina',
      subtitle: 'Objeto físico / variantes de acabado',
      concept: 'Corazón anatómico dorado atrapado en una cápsula translúcida: reliquia médica, vitrina y altar pequeño.',
    ...
    arcangelito: {
      ...
      code: 'ARCANGELITO.v01',
      title: 'ARCANGELITO.v01',
      stateKey: 'state.partyAnimalGestando',
      actionTitle: 'Arcangelito',
      series: 'Objetos · arcangel barroco',
  ...
  const ROUTING = {
    ...
    'corazon-capsula': { modal: 'modal-party-animal', modalSlug: 'corazon-capsula', partyAnimal: 'corazon-capsula', scrollTo: 'pieza-corazon-capsula', titulo: 'CORAZON_CAPSULA.v01 · Simio Plateado', img: PARTY_ANIMALS['corazon-capsula'].img, descripcion: 'CORAZON_CAPSULA.v01 en Simio Plateado: corazón dorado encerrado en cápsula translúcida.' },
    ...
    'sphinx-tenebrosa': { modal: 'modal-literato', modalSlug: 'sphinx-tenebrosa', literato: 'sphinx-tenebrosa', scrollTo: 'pieza-sphinx-tenebrosa', titulo: 'SPHINX TENEBROSA · Panteón Argenti · Simio Plateado', img: LITERATOS['sphinx-tenebrosa'].img, descripcion: 'PA-002 SPHINX TENEBROSA en Simio Plateado: La Esfinge del Templo Hundido, Panteón Argenti Vol. I.' },
    ...
    'arcangelito': { modal: 'modal-party-animal', modalSlug: 'arcangelito', partyAnimal: 'arcangelito', scrollTo: 'pieza-arcangelito', titulo: 'ARCANGELITO.v01 · Simio Plateado', img: PARTY_ANIMALS.arcangelito.img, descripcion: 'ARCANGELITO.v01 en Simio Plateado: estatua barroca con foto real y modelo 3D.' },
