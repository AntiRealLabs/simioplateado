  ...
  const GALERIA_GROUPS = [
    ...
    { family: 'panteon-argenti', titleKey: 'filter.family.panteonArgenti', copyKey: 'gallery.group.panteonArgenti' },
  ...
  const GALERIA_PRIORITY = {
    ...
    'pieza-sherk-buchon': 41,
    'pieza-mater-cuchilla': 42,
    'pieza-michael-lean': 43,
    'pieza-corazon-capsula': 44,
    'pieza-coleccion-feli': 45,
    'pieza-venus-feli': 46,
    'pieza-pensador-feli': 47,
    'pieza-david-feli': 48,
    'pieza-vorator-coronarum': 49,
    'pieza-sphinx-tenebrosa': 50,
    'pieza-geminae-doloris': 51,
    'pieza-aureus-mendicans': 52,
    'pieza-arcangelito': 53
  };
	      ...
	      alt: 'BICHO_K.v01'
		    ...
		    'dostoiecito': {
		      ...
		      concept: 'Mini Fiodor rosado, severo y portátil: hacha mínima, ficha de apuesta y toda la culpa convertida en pieza de escritorio.',
			      production: 'Compra segura vía Mercado Pago. Pieza FDM intervenida a mano en Medellín. Medidas aproximadas: 18 cm alto x 11 cm ancho x 11 cm profundo. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
		    ...
		    'acefalo': {
		      ...
		      production: 'Compra segura vía Mercado Pago. Pieza FDM intervenida a mano en Medellín. Medidas aproximadas: 25 cm alto x 20 cm ancho x 5 cm profundo. Esta unidad va sin caja. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
		    ...
		    'coleccion-feli': {
		      slug: 'coleccion-feli',
		      code: 'COLECCION_FELI.v01',
		      title: 'COLECCION_FELI.v01',
		      checkoutSlug: 'coleccion-feli',
		      price: 'COP 400.000 · USD 100 ref. · 3 piezas juntas',
		      state: 'Disponible · compra abierta',
		      series: 'Objetos · clásicos feli',
		      subtitle: 'Colección física / Venus + Pensador + David / Drop 001',
		      concept: 'Tres estatuas felices reunidas: Venus, Pensador y David en versión piedra amable, como pequeño altar clásico con cara de buen día.',
		      production: 'Compra segura vía Mercado Pago. Colección de 3 piezas FDM terminadas a mano en Medellín. Precio especial por llevar las tres juntas. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
		      priceNote: 'Precio especial colección: COP 400.000. Referencia aproximada: USD 100. Mercado Pago procesa el cobro en COP.',
		      caption: 'Foto real de la colección',
		      img: 'assets/optimized/processed/piezas/objetos/coleccion-feli-cutout.webp',
		      imageVersion: '20260629-feli-real',
		      variants: [
		        { src: 'assets/optimized/processed/piezas/objetos/venus-feli-cutout.webp', caption: 'Venus Feli', version: '20260629-feli-cutout' },
		        { src: 'assets/optimized/processed/piezas/objetos/pensador-feli-cutout.webp', caption: 'Pensador Feli', version: '20260629-feli-cutout' },
		        { src: 'assets/optimized/processed/piezas/objetos/david-feli-cutout.webp', caption: 'David Feli', version: '20260629-feli-cutout' }
		      ],
		      alt: 'COLECCION_FELI.v01 tres estatuas fisicas terminadas'
		    },
		    'venus-feli': {
		      slug: 'venus-feli',
		      code: 'VENUS_FELI.v01',
		      title: 'VENUS_FELI.v01',
		      checkoutSlug: 'venus-feli',
		      price: 'COP 150.000 · USD 37.5 ref. · pieza disponible',
		      state: 'Disponible · compra abierta',
		      series: 'Objetos · clásicos feli',
		      subtitle: 'Estatua física / Venus sonriente / Drop 001',
		      concept: 'Venus clásica intervenida por una cara feliz: piedra antigua con ánimo extraño, amable y un poco fuera de época.',
		      production: 'Compra segura vía Mercado Pago. Pieza FDM terminada a mano en Medellín. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
		      priceNote: 'Precio: COP 150.000. Referencia aproximada: USD 37.5. Mercado Pago procesa el cobro en COP.',
		      caption: 'Foto real del 3D',
		      img: 'assets/optimized/processed/piezas/objetos/venus-feli-cutout.webp',
		      imageVersion: '20260629-feli-real',
		      model: 'assets/models/objetos/venus-feli.glb',
		      modelVersion: '20260629-feli',
		      modelCaption: 'Modelo 3D web',
		      cameraTarget: '0m 0.6m 0m',
		      cameraOrbit: '90deg 74deg 2.35m',
		      fieldOfView: '28deg',
		      variants: [
		        { src: 'assets/optimized/processed/piezas/objetos/coleccion-feli-cutout.webp', caption: 'Colección Feli', version: '20260629-feli-cutout' }
		      ],
		      alt: 'VENUS_FELI.v01 pieza fisica terminada'
		    },
		    'pensador-feli': {
		      slug: 'pensador-feli',
		      code: 'PENSADOR_FELI.v01',
		      title: 'PENSADOR_FELI.v01',
		      checkoutSlug: 'pensador-feli',
		      price: 'COP 180.000 · USD 45 ref. · pieza disponible',
		      state: 'Disponible · compra abierta',
		      series: 'Objetos · clásicos feli',
		      subtitle: 'Estatua física / pensamiento sonriente / Drop 001',
		      concept: 'Pensador sentado con sonrisa de piedra: una duda clásica que ya no se angustia tanto y mira el mundo con cara feliz.',
		      production: 'Compra segura vía Mercado Pago. Pieza FDM terminada a mano en Medellín. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
		      priceNote: 'Precio: COP 180.000. Referencia aproximada: USD 45. Mercado Pago procesa el cobro en COP.',
		      caption: 'Foto real del 3D',
		      img: 'assets/optimized/processed/piezas/objetos/pensador-feli-cutout.webp',
		      imageVersion: '20260629-feli-real',
		      model: 'assets/models/objetos/pensador-feli.glb',
		      modelVersion: '20260629-feli',
		      modelCaption: 'Modelo 3D web',
		      cameraTarget: '0m 0.55m 0m',
		      cameraOrbit: '90deg 73deg 2.35m',
		      fieldOfView: '28deg',
		      variants: [
		        { src: 'assets/optimized/processed/piezas/objetos/coleccion-feli-cutout.webp', caption: 'Colección Feli', version: '20260629-feli-cutout' }
		      ],
		      alt: 'PENSADOR_FELI.v01 pieza fisica terminada'
		    },
		    'david-feli': {
		      slug: 'david-feli',
		      code: 'DAVID_FELI.v01',
		      title: 'DAVID_FELI.v01',
		      checkoutSlug: 'david-feli',
		      price: 'COP 150.000 · USD 37.5 ref. · pieza disponible',
		      state: 'Disponible · compra abierta',
		      series: 'Objetos · clásicos feli',
		      subtitle: 'Estatua física / David sonriente / Drop 001',
		      concept: 'David clásico con gesto feliz y pequeño sello travieso: solemnidad renacentista bajada a objeto raro de escritorio.',
		      production: 'Compra segura vía Mercado Pago. Pieza FDM terminada a mano en Medellín. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
		      priceNote: 'Precio: COP 150.000. Referencia aproximada: USD 37.5. Mercado Pago procesa el cobro en COP.',
		      caption: 'Foto real del 3D',
		      img: 'assets/optimized/processed/piezas/objetos/david-feli-cutout.webp',
		      imageVersion: '20260629-feli-real',
		      model: 'assets/models/objetos/david-feli.glb',
		      modelVersion: '20260629-feli',
		      modelCaption: 'Modelo 3D web',
		      cameraTarget: '0m 0.7m 0m',
		      cameraOrbit: '90deg 74deg 2.55m',
		      fieldOfView: '27deg',
		      variants: [
		        { src: 'assets/optimized/processed/piezas/objetos/coleccion-feli-cutout.webp', caption: 'Colección Feli', version: '20260629-feli-cutout' }
		      ],
		      alt: 'DAVID_FELI.v01 pieza fisica terminada'
		    },
		    'vorator-coronarum': {
		      slug: 'vorator-coronarum',
		      code: 'PA-001 · VORATOR CORONARUM',
		      title: 'VORATOR CORONARUM',
		      state: 'Gestándose · en producción',
		      series: 'Panteón Argenti · Vol. I · Rey hambriento · Los Cuatro Cansados',
		      subtitle: 'El Devorador de Coronas',
		      concept: 'El rey que consumió su propia dinastía y ahora sostiene la calavera de su última herencia.',
		      production: 'Estado: en producción. SKU PA-001. Línea Panteón Argenti · Volumen I. Foto de referencia cargada; falta confirmar GLB/STL, escala, precio y tirada antes de abrir compra.',
		      caption: 'Estudio visual / Panteón Argenti',
		      img: 'assets/optimized/processed/piezas/panteon-argenti/vorator-coronarum-cutout.webp',
		      imageVersion: '20260629-panteon-argenti',
		      interestMode: 'have',
		      alt: 'VORATOR_CORONARUM Panteon Argenti rey en trono con calavera'
		    },
		    'sphinx-tenebrosa': {
		      slug: 'sphinx-tenebrosa',
		      code: 'PA-002 · SPHINX TENEBROSA',
		      title: 'SPHINX TENEBROSA',
		      checkoutSlug: 'sphinx-tenebrosa',
		      price: 'COP 250.000 · USD 63 ref. · precio lanzamiento',
		      state: 'Disponible · compra abierta',
		      original: true,
		      series: 'Panteón Argenti · Vol. I · Guardiana eterna · Los Cuatro Servidores',
		      subtitle: 'La Esfinge del Templo Hundido',
		      concept: 'Custodia el umbral del templo desde antes que el templo existiera. Custodiará cuando ya no quede templo.',
		      production: 'Compra abierta con precio de lanzamiento. Pieza FDM dorada, orgullosamente original, nacida en Panteón Argenti · Volumen I. Impresión aproximada: 16 horas. Valor de referencia: COP 280.000. Envío nacional incluido en Colombia; para envíos internacionales mostramos total con envío incluido y confirmamos por email antes de cobrar.',
		      priceNote: 'Precio lanzamiento: COP 250.000. Valor de referencia: COP 280.000. Referencia aproximada: USD 63. Mercado Pago procesa el cobro en COP.',
		      caption: 'Foto real de la pieza impresa',
		      img: 'assets/optimized/processed/piezas/panteon-argenti/sphinx-tenebrosa-real-cutout.webp',
		      imageVersion: '20260629-sphinx-real',
		      alt: 'PA-002 SPHINX TENEBROSA pieza fisica dorada terminada'
		    },
		    'geminae-doloris': {
		      slug: 'geminae-doloris',
		      code: 'PA-003 · GEMINAE DOLORIS',
		      title: 'GEMINAE DOLORIS',
		      state: 'Gestándose · en producción',
		      series: 'Panteón Argenti · Vol. I · Dualidad fracturada · Los Cuatro Hijos',
		      subtitle: 'Las Gemelas del Dolor',
		      concept: 'Una mira hacia lo que viene, la otra hacia lo que se perdió. Ninguna podrá mirar a la otra jamás.',
		      production: 'Estado: en producción. SKU PA-003. Línea Panteón Argenti · Volumen I. Foto de referencia cargada; falta confirmar GLB/STL, escala, precio y tirada antes de abrir compra.',
		      caption: 'Estudio visual / Panteón Argenti',
		      img: 'assets/optimized/processed/piezas/panteon-argenti/geminae-doloris-cutout.webp',
		      imageVersion: '20260629-panteon-argenti',
		      interestMode: 'have',
		      alt: 'GEMINAE_DOLORIS Panteon Argenti dos figuras ceremoniales espalda con espalda'
		    },
		    'aureus-mendicans': {
		      slug: 'aureus-mendicans',
		      code: 'PA-004 · AUREUS MENDICANS',
		      title: 'AUREUS MENDICANS',
		      state: 'Gestándose · en producción',
		      series: 'Panteón Argenti · Vol. I · Divinidad reducida · Los Cuatro Olvidados',
		      subtitle: 'El Pordiosero Dorado',
		      concept: 'Antes el más rico del panteón. Ahora su propio oro le supura sin parar, y mendiga limosna que nunca podrá gastar.',
		      production: 'Estado: en producción. SKU PA-004. Línea Panteón Argenti · Volumen I. Foto de referencia cargada; falta confirmar GLB/STL, escala, precio y tirada antes de abrir compra.',
		      caption: 'Estudio visual / Panteón Argenti',
		      img: 'assets/optimized/processed/piezas/panteon-argenti/aureus-mendicans-cutout.webp',
		      imageVersion: '20260629-panteon-argenti',
		      interestMode: 'have',
		      alt: 'AUREUS_MENDICANS Panteon Argenti rey mendicante con cuenco dorado'
		    },
		    'gabito': {
		      slug: 'gabito',
			      code: 'GABITO.v01',
		      ...
		      production: 'Compra segura vía Mercado Pago. Pieza FDM intervenida a mano en Medellín. Medidas aproximadas en caja: 16 cm alto x 10 cm ancho x 10 cm profundo. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
	      ...
	      concept: 'Poeta áspero de camisa blanca, lata, gato y papeles: antiheroísmo de escritorio.',
		      ...
		      alt: 'KOWSKITO.v01'
				    ...
				    'quijotico': {
				      ...
				      production: 'Compra segura vía Mercado Pago. Pieza FDM intervenida a mano en Medellín, con lanza fina y alto nivel de detalle. Medidas finales por confirmar antes de despacho. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
  ...
  const PARTY_ANIMALS = {
    bunnivil: {
      ...
      img: 'assets/optimized/processed/piezas/party-animals/bunnivil-cutout.webp',
    ...
    felpi: {
      ...
      img: 'assets/optimized/processed/piezas/party-animals/felpi-cutout.webp',
    ...
    'flow-eater': {
      ...
      concept: 'Cerdito rosado abrazado a un parlante negro: se alimenta de beat y devuelve ternura saturada.',
	      production: 'GLB web-ready y título handwritten cargados. Falta decidir escala, material, acabado y tirada.',
      img: 'assets/optimized/processed/piezas/party-animals/flow-eater-cutout.webp',
    ...
    flowlamar: {
      ...
      production: 'GLB web-ready cargado. Falta título handwritten, escala, material, acabado y tirada.',
      img: 'assets/optimized/processed/piezas/party-animals/flowlamar-cutout.webp',
    ...
    slimmy: {
      ...
      concept: 'Fantasma verde con speaker frontal: gelatina tímida, mirada perdida y volumen interno.',
	      production: 'GLB web-ready y título handwritten cargados. Falta decidir escala, material, acabado y tirada.',
      img: 'assets/optimized/processed/piezas/party-animals/slimmy-cutout.webp',
    ...
    'gorilla-bass': {
      ...
      concept: 'Gorila gris con cadena, gorra y bocina frontal: fuerza amable para cargar el bajo como amuleto.',
	      production: 'GLB web-ready y título handwritten cargados. Falta decidir escala, material, acabado y tirada.',
      img: 'assets/optimized/processed/piezas/party-animals/gorilla-bass-cutout.webp',
    ...
    'sound-creature': {
      ...
      img: 'assets/optimized/processed/piezas/bocinas/sound-creature-cutout.webp',
    ...
    'visual-sounds': {
      ...
      production: 'Imagen sin fondo y GLB web-ready cargados. Falta validar escala, electrónica, material, acabado y tirada.',
      img: 'assets/optimized/processed/piezas/bocinas/visual-sounds-cutout.webp',
      imageVersion: '20260609-bocinas',
    ...
    'sonidos-del-alma': {
      ...
      production: 'Imagen sin fondo y GLB web-ready cargados. Falta validar escala, electrónica, material, acabado y tirada.',
      img: 'assets/optimized/processed/piezas/bocinas/sonidos-del-alma-cutout.webp',
      imageVersion: '20260609-bocinas',
    ...
    'mental-sounds': {
      ...
      img: 'assets/optimized/processed/piezas/bocinas/mental-sounds-cutout.webp',
      imageVersion: '20260609-bocinas',
    ...
    'vida-y-pena': {
      ...
      subtitle: 'Estatua ritual / foto real impresa + modelo 3D',
      concept: 'Máscara abierta sobre arquitectura espinada: una pieza entre teatro, reliquia y duelo materializado.',
      production: 'Foto real de la pieza impresa y GLB web-ready cargados. Falta validar medidas, acabado y precio final antes de abrir compra.',
      img: 'assets/optimized/processed/piezas/objetos/vida-y-pena-real-cutout.webp',
      imageVersion: '20260629-vida-pena-real',
      caption: 'Foto real de la pieza impresa',
      ...
      fieldOfView: '26deg',
      alt: 'VIDA_Y_PENA.v01 pieza fisica impresa'
    },
    'sherk-buchon': {
      slug: 'sherk-buchon',
      sondeoSlug: 'sherk-buchon-v01',
      code: 'SHERK_BUCHON.v01',
      title: 'SHERK_BUCHON.v01',
      stateKey: 'state.partyAnimalGestando',
      actionTitle: 'Sherk Buchon',
      series: 'Objetos · criatura buchona',
      subtitle: 'Figura física / foto real + modelo 3D',
      concept: 'Criatura verde translúcida con gorra y chaleco: un ogro de barrio convertido en amuleto buchón.',
      production: 'Foto real y GLB web-ready cargados. Falta validar escala, material, acabado y precio final.',
      img: 'assets/optimized/processed/piezas/objetos/sherk-buchon-cutout.webp',
      imageVersion: '20260623-sherk',
      model: 'assets/models/objetos/sherk-buchon.glb',
      modelVersion: '20260623-sherk',
      cameraTarget: '0m 0.55m 0m',
      cameraOrbit: '90deg 74deg 2.25m',
      fieldOfView: '30deg',
      alt: 'SHERK_BUCHON.v01'
    },
    'mater-cuchilla': {
      slug: 'mater-dolorosa',
      sondeoSlug: 'mater-dolorosa-v01',
      code: 'MATER_DOLOROSA.v01',
      title: 'MATER_DOLOROSA.v01',
      original: true,
      stateKey: 'state.partyAnimalGestando',
      actionTitle: 'Mater Dolorosa',
      series: 'Objetos · dolor barroco',
      subtitle: 'Estatua física / foto real + modelo 3D',
      concept: 'Figura ceremonial con corona, manto y corazón atravesado: una pieza de dolor plateado, devoción y filo.',
      production: 'Foto real, referencia visual y GLB web-ready cargados. Falta validar escala, material, acabado y precio final.',
      img: 'assets/optimized/processed/piezas/objetos/mater-cuchilla-real-cutout.webp',
      imageVersion: '20260623-mater',
      model: 'assets/models/objetos/mater-cuchilla.glb',
      modelVersion: '20260623-mater',
      cameraTarget: '0m 0.65m 0m',
      cameraOrbit: '90deg 75deg 2.45m',
      fieldOfView: '28deg',
      variants: [
        { src: 'assets/optimized/processed/piezas/objetos/mater-cuchilla-ref.webp', caption: 'Referencia escultórica', version: '20260623-mater-ref' }
      ],
      alt: 'MATER_DOLOROSA.v01'
    },
    'michael-lean': {
      slug: 'michael-lean',
      sondeoSlug: 'michael-lean-v01',
      code: 'MICHAEL_LEAN.v01',
      title: 'MICHAEL_LEAN.v01',
      stateKey: 'state.visualOnly',
      actionTitle: 'Michael Lean',
      series: 'Objetos · inclinación imposible',
      subtitle: 'Figura física / foto real',
      concept: 'Silueta negra en inclinación antigravedad: gesto pop congelado en una base mínima.',
      production: 'Foto real cargada. Falta ubicar el GLB correspondiente para activar visor 3D, validar escala, acabado y precio.',
      img: 'assets/optimized/processed/piezas/objetos/michael-lean-cutout.webp',
      imageVersion: '20260623-michael',
      alt: 'MICHAEL_LEAN.v01'
    },
    'corazon-capsula': {
      slug: 'corazon-capsula',
      sondeoSlug: 'corazon-capsula-v01',
      code: 'CORAZON_RELICARIO.v01',
      title: 'CORAZON_RELICARIO.v01',
      original: true,
      stateKey: 'state.visualOnly',
      actionTitle: 'Corazon Relicario',
      series: 'Objetos · reliquia en vitrina',
      subtitle: 'Objeto físico / variantes de acabado',
      concept: 'Corazón anatómico dorado atrapado en una cápsula translúcida: relicario médico, vitrina y altar pequeño.',
      production: 'Fotos reales y variantes de acabado cargadas. Falta ubicar el GLB correspondiente para activar visor 3D, validar escala y precio.',
      img: 'assets/optimized/processed/piezas/objetos/corazon-capsula-dark-cutout.webp',
      imageVersion: '20260623-corazon',
      variants: [
        { src: 'assets/optimized/processed/piezas/objetos/corazon-capsula-clear.webp', caption: 'Versión transparente', version: '20260623-corazon-clear' }
      ],
      alt: 'CORAZON_RELICARIO.v01'
    },
    happensador: {
      slug: 'happensador',
      sondeoSlug: 'happensador-v01',
      code: 'HAPPENSADOR.v01',
      title: 'HAPPENSADOR.v01',
      stateKey: 'state.partyAnimalGestando',
      actionTitle: 'Happensador',
      series: 'Objetos · estatua pensante',
      subtitle: 'Estatua / imagen sin fondo + modelo 3D',
      concept: 'Pensador sonriente, sentado entre piedra y caricatura: una estatua que parece entender demasiado y aun así decide sonreír.',
      production: 'Imagen sin fondo y GLB web-ready cargados. Falta validar escala, material, acabado y precio final.',
      img: 'assets/optimized/processed/piezas/objetos/happensador.webp',
      imageVersion: '20260623-happensador',
      model: 'assets/models/objetos/happensador.glb',
      modelVersion: '20260623-happensador',
      cameraTarget: '0m 0.55m 0m',
      cameraOrbit: '90deg 73deg 2.35m',
      fieldOfView: '28deg',
      alt: 'HAPPENSADOR.v01'
    ...
    arcangelito: {
      slug: 'arcangelito',
      sondeoSlug: 'arcangelito-v01',
      code: 'SAN_MIGUEL.v01',
      title: 'SAN_MIGUEL.v01',
      original: true,
      stateKey: 'state.partyAnimalGestando',
      actionTitle: 'San Miguel',
      series: 'Objetos · batalla celestial',
      subtitle: 'Estatua / foto real + modelo 3D',
      concept: 'Arcangel ornamental con alas abiertas, espada, escudo y demonio vencido: una miniatura de batalla celestial llevada al altar de escritorio.',
      production: 'Foto real y GLB web-ready cargados. Falta validar escala, soportes de impresion, material, acabado y precio final.',
      img: 'assets/optimized/processed/piezas/objetos/arcangelito-cutout.webp',
      imageVersion: '20260623-arcangelito',
      model: 'assets/models/objetos/arcangelito.glb',
      modelVersion: '20260623-arcangelito',
      cameraTarget: '0m 0.75m 0m',
      cameraOrbit: '90deg 74deg 2.75m',
      fieldOfView: '26deg',
      alt: 'SAN_MIGUEL.v01'
    }
  };
  ...
  const SIMIUGS = {
    ...
    goticup: {
      ...
      state: 'Prototipo real · vaso funcional',
      series: 'Simiugs · gótico táctil',
      subtitle: 'Simiugs / vaso funcional + acero inoxidable',
      concept: 'Dedos largos, relieve ornamental, asa ósea y vaso de acero inoxidable: una taza litúrgica para tomar sombra.',
	      production: 'Foto real del prototipo funcional cargada. Incluye vaso de acero inoxidable, GLB web-ready y título handwritten. Falta definir precio final, escala de tirada y apertura de pedido.',
      img: 'assets/optimized/processed/piezas/simiugs/goticup-real.ab0825b653.webp',
      model: 'assets/models/simiugs/goticup.glb',
      mediaCaption: 'Foto real del prototipo funcional',
      alt: 'GOTICUP.v01'
    },
    kubikup: {
      slug: 'kubikup',
  ...
  const ENCARGOS_TRIPO_DRAFT_KEY = 'simio_encargo_tripo_draft_v1';
  const LEGAL_META = {
    privacidad: {
  ...
  const ROUTING = {
    ...
    'vida-y-pena': { modal: 'modal-party-animal', modalSlug: 'vida-y-pena', partyAnimal: 'vida-y-pena', scrollTo: 'pieza-vida-y-pena', titulo: 'VIDA_Y_PENA.v01 · Simio Plateado', img: PARTY_ANIMALS['vida-y-pena'].img, descripcion: 'VIDA_Y_PENA.v01 en Simio Plateado: estatua ritual Fatum et Dolor con foto real de la pieza impresa y modelo 3D.' },
    'sherk-buchon': { modal: 'modal-party-animal', modalSlug: 'sherk-buchon', partyAnimal: 'sherk-buchon', scrollTo: 'pieza-sherk-buchon', titulo: 'SHERK_BUCHON.v01 · Simio Plateado', img: PARTY_ANIMALS['sherk-buchon'].img, descripcion: 'SHERK_BUCHON.v01 en Simio Plateado: criatura verde buchona con foto real y modelo 3D.' },
    'mater-cuchilla': { modal: 'modal-party-animal', modalSlug: 'mater-cuchilla', partyAnimal: 'mater-cuchilla', scrollTo: 'pieza-mater-cuchilla', titulo: 'MATER_DOLOROSA.v01 · Simio Plateado', img: PARTY_ANIMALS['mater-cuchilla'].img, descripcion: 'MATER_DOLOROSA.v01 en Simio Plateado: estatua ceremonial de dolor barroco con foto real, referencia y modelo 3D.' },
    'mater-dolorosa': { modal: 'modal-party-animal', modalSlug: 'mater-cuchilla', partyAnimal: 'mater-cuchilla', scrollTo: 'pieza-mater-cuchilla', titulo: 'MATER_DOLOROSA.v01 · Simio Plateado', img: PARTY_ANIMALS['mater-cuchilla'].img, descripcion: 'MATER_DOLOROSA.v01 en Simio Plateado: estatua ceremonial de dolor barroco con foto real, referencia y modelo 3D.' },
    'michael-lean': { modal: 'modal-party-animal', modalSlug: 'michael-lean', partyAnimal: 'michael-lean', scrollTo: 'pieza-michael-lean', titulo: 'MICHAEL_LEAN.v01 · Simio Plateado', img: PARTY_ANIMALS['michael-lean'].img, descripcion: 'MICHAEL_LEAN.v01 en Simio Plateado: figura física en inclinación imposible.' },
    'corazon-capsula': { modal: 'modal-party-animal', modalSlug: 'corazon-capsula', partyAnimal: 'corazon-capsula', scrollTo: 'pieza-corazon-capsula', titulo: 'CORAZON_RELICARIO.v01 · Simio Plateado', img: PARTY_ANIMALS['corazon-capsula'].img, descripcion: 'CORAZON_RELICARIO.v01 en Simio Plateado: corazón dorado encerrado en cápsula translúcida.' },
    'corazon-relicario': { modal: 'modal-party-animal', modalSlug: 'corazon-capsula', partyAnimal: 'corazon-capsula', scrollTo: 'pieza-corazon-capsula', titulo: 'CORAZON_RELICARIO.v01 · Simio Plateado', img: PARTY_ANIMALS['corazon-capsula'].img, descripcion: 'CORAZON_RELICARIO.v01 en Simio Plateado: corazón dorado encerrado en cápsula translúcida.' },
    'coleccion-feli': { modal: 'modal-literato', modalSlug: 'coleccion-feli', literato: 'coleccion-feli', scrollTo: 'pieza-coleccion-feli', titulo: 'COLECCION_FELI.v01 · Simio Plateado', img: LITERATOS['coleccion-feli'].img, descripcion: 'COLECCION_FELI.v01 en Simio Plateado: Venus Feli, Pensador Feli y David Feli juntos con precio especial.' },
    'venus-feli': { modal: 'modal-literato', modalSlug: 'venus-feli', literato: 'venus-feli', scrollTo: 'pieza-venus-feli', titulo: 'VENUS_FELI.v01 · Simio Plateado', img: LITERATOS['venus-feli'].img, descripcion: 'VENUS_FELI.v01 disponible en Simio Plateado: estatua clásica intervenida, foto real, modelo 3D y compra abierta.' },
    'pensador-feli': { modal: 'modal-literato', modalSlug: 'pensador-feli', literato: 'pensador-feli', scrollTo: 'pieza-pensador-feli', titulo: 'PENSADOR_FELI.v01 · Simio Plateado', img: LITERATOS['pensador-feli'].img, descripcion: 'PENSADOR_FELI.v01 disponible en Simio Plateado: estatua pensante con foto real, modelo 3D y compra abierta.' },
    'david-feli': { modal: 'modal-literato', modalSlug: 'david-feli', literato: 'david-feli', scrollTo: 'pieza-david-feli', titulo: 'DAVID_FELI.v01 · Simio Plateado', img: LITERATOS['david-feli'].img, descripcion: 'DAVID_FELI.v01 disponible en Simio Plateado: estatua clásica intervenida, foto real, modelo 3D y compra abierta.' },
    'vorator-coronarum': { modal: 'modal-literato', modalSlug: 'vorator-coronarum', literato: 'vorator-coronarum', scrollTo: 'pieza-vorator-coronarum', titulo: 'VORATOR CORONARUM · Panteón Argenti · Simio Plateado', img: LITERATOS['vorator-coronarum'].img, descripcion: 'PA-001 VORATOR CORONARUM en Simio Plateado: El Devorador de Coronas, Panteón Argenti Vol. I.' },
    'sphinx-tenebrosa': { modal: 'modal-literato', modalSlug: 'sphinx-tenebrosa', literato: 'sphinx-tenebrosa', scrollTo: 'pieza-sphinx-tenebrosa', titulo: 'SPHINX TENEBROSA · Panteón Argenti · Simio Plateado', img: LITERATOS['sphinx-tenebrosa'].img, descripcion: 'PA-002 SPHINX TENEBROSA disponible en Simio Plateado: La Esfinge del Templo Hundido, pieza física dorada de Panteón Argenti Vol. I.' },
    'geminae-doloris': { modal: 'modal-literato', modalSlug: 'geminae-doloris', literato: 'geminae-doloris', scrollTo: 'pieza-geminae-doloris', titulo: 'GEMINAE DOLORIS · Panteón Argenti · Simio Plateado', img: LITERATOS['geminae-doloris'].img, descripcion: 'PA-003 GEMINAE DOLORIS en Simio Plateado: Las Gemelas del Dolor, Panteón Argenti Vol. I.' },
    'aureus-mendicans': { modal: 'modal-literato', modalSlug: 'aureus-mendicans', literato: 'aureus-mendicans', scrollTo: 'pieza-aureus-mendicans', titulo: 'AUREUS MENDICANS · Panteón Argenti · Simio Plateado', img: LITERATOS['aureus-mendicans'].img, descripcion: 'PA-004 AUREUS MENDICANS en Simio Plateado: El Pordiosero Dorado, Panteón Argenti Vol. I.' },
    'arcangelito': { modal: 'modal-party-animal', modalSlug: 'arcangelito', partyAnimal: 'arcangelito', scrollTo: 'pieza-arcangelito', titulo: 'SAN_MIGUEL.v01 · Simio Plateado', img: PARTY_ANIMALS.arcangelito.img, descripcion: 'SAN_MIGUEL.v01 en Simio Plateado: estatua barroca con foto real y modelo 3D.' },
    ...
    'goticup': { modal: 'modal-simiug', modalSlug: 'simiug', simiug: 'goticup', scrollTo: 'pieza-goticup', titulo: 'GOTICUP.v01 · Simiugs · Simio Plateado', img: SIMIUGS.goticup.img, descripcion: 'Simiugs de Simio Plateado: GOTICUP.v01 como vaso funcional con acero inoxidable y foto real.' },
  ...
  const ROUTE_ALIASES = {
    ...
    'sherk-buchon-v01': 'sherk-buchon',
    'sherk': 'sherk-buchon',
    'sherk-buchon': 'sherk-buchon',
    'mater-cuchilla': 'mater-dolorosa',
    'mater-cuchilla-v01': 'mater-dolorosa',
    'mater-dolorosa-v01': 'mater-dolorosa',
    'mater-dolor': 'mater-dolorosa',
    'virgen-cuchillera': 'mater-dolorosa',
    'michael-lean-v01': 'michael-lean',
    'corazon-capsula-v01': 'corazon-capsula',
    'corazon-en-capsula': 'corazon-capsula',
    'corazon-relicario': 'corazon-capsula',
    'corazon-relicario-v01': 'corazon-capsula',
    'coleccion-feli-v01': 'coleccion-feli',
    'felis-clasicos': 'coleccion-feli',
    'felis-clasicos-v01': 'coleccion-feli',
    'venus-feli-v01': 'venus-feli',
    'pensador-feli-v01': 'pensador-feli',
    'happensador': 'pensador-feli',
    'happensador-v01': 'pensador-feli',
    'david-feli-v01': 'david-feli',
    'panteon-argenti': 'vorator-coronarum',
    'panteon-argenti-vol-i': 'vorator-coronarum',
    'pa-001': 'vorator-coronarum',
    'vorator-coronarum-v01': 'vorator-coronarum',
    'devorador-de-coronas': 'vorator-coronarum',
    'pa-002': 'sphinx-tenebrosa',
    'sphinx-tenebrosa-v01': 'sphinx-tenebrosa',
    'esfinge-tenebrosa': 'sphinx-tenebrosa',
    'pa-003': 'geminae-doloris',
    'geminae-doloris-v01': 'geminae-doloris',
    'gemelas-del-dolor': 'geminae-doloris',
    'pa-004': 'aureus-mendicans',
    'aureus-mendicans-v01': 'aureus-mendicans',
    'pordiosero-dorado': 'aureus-mendicans',
    'arcangelito-v01': 'arcangelito',
    'san-miguelito': 'arcangelito',
    'san-miguelito-v01': 'arcangelito',
    'san-miguel': 'arcangelito',
    'san-miguel-v01': 'arcangelito',
    'arcangel': 'arcangelito',
  ...
  function renderEncargosCrear() {
    ...
    Object.assign(encargoState, cargarBorradorTripoEncargo());
      ...
      <article class="page-encargos encargos-wizard">
        ...
        <section class="encargos-step" data-encargo-step="1">
          ...
          <div class="encargos-form-grid">
            ...
            <div>
              <p class="encargos-mini">Puedes generar una vista 3D preliminar y consultar su estado sin volver a gastar otra generacion.</p>
          ...
          <div class="encargos-preview-grid">
            <div>
              ...
              <div class="encargos-actions">
                ...
                <button type="button" class="secundario" id="encargo-manual-btn">Continuar con revision manual</button>
              </div>
              <p class="encargos-field-note">Si el modelo tarda o no acierta, puedes continuar igual. Revisamos manualmente la imagen, el sujeto y la viabilidad antes de cotizar.</p>
        ...
        <section class="encargos-step" data-encargo-step="3" hidden>
          ...
          <div class="encargos-preview-grid">
            ...
            <div>
              ...
              <label class="encargos-field encargos-model-comments">
                <span>Ajustes sobre el modelo generado</span>
                <textarea id="encargo-modelo-comentarios" maxlength="900" placeholder="Ej. conservar solo el perrito sentado, quitar la base roja, suavizar el rostro, hacer las orejas mas grandes..."></textarea>
              </label>
              <p class="encargos-field-note">Opcional. Escribe aqui lo que quieras corregir, conservar o aclarar despues de ver esta vista preliminar.</p>
  ...
  function iniciarEncargosCrear() {
    ...
    root.querySelector('#encargo-email-next')?.addEventListener('click', () => {
      ...
      trackSimio('encargos_step_view', 'encargos', { step: 2, source: 'email_step' });
    });
    ...
    root.querySelector('#encargo-imagen')?.addEventListener('change', async (event) => {
      ...
      encargoState.conceptualPrompt = '';
      encargoState.tripoTaskId = '';
      encargoState.tripoStatus = '';
      encargoState.tripoProgress = 0;
      encargoState.tripoModelUrl = '';
      encargoState.tripoRenderedImageUrl = '';
      encargoState.tripoFileToken = '';
      encargoState.tripoCreditsConsumed = 0;
      limpiarBorradorTripoEncargo();
      const btn = root.querySelector('#encargo-preview-btn');
      if (btn) btn.textContent = 'Generar modelo 3D';
      try {
        ...
        setFrameMessage(root.querySelector('#encargo-preview-frame'), 'Modelo 3D', 'Cuando la imagen y la indicacion esten listas, genera el modelo preliminar.');
        setEncargoStatus(root, 2, '');
        trackSimio('encargos_image_uploaded', 'encargos', { source: 'image_step', type: file.type || '', bytes: file.size || 0 });
      } catch (_) {
    ...
    root.querySelector('#encargo-manual-btn')?.addEventListener('click', () => continuarEncargoManual(root));
  ...
  function opcionesEncargoDesdeFormulario(root) {
    return {
      ...
      modelNotes: (root.querySelector('#encargo-modelo-comentarios')?.value || '').trim().slice(0, 900)
    };
  }
  ...
  function actualizarPrecioEncargo(root) {
    ...
    if (note) {
      note.textContent = price.shipping.amount === null
        ? 'Precio estimado con envio internacional incluido · final por confirmar.'
  ...
  function guardarTripoEncargo(data = {}) {
    ...
    guardarBorradorTripoEncargo();
  }

  function tripoEstaPendiente(status) {
    const normalized = String(status || '').toLowerCase();
    return !normalized || normalized === 'queued' || normalized === 'running' || normalized === 'processing';
  }

  function crearErrorTripoPendiente(message) {
    const error = new Error(message);
    error.tripoPending = true;
    return error;
  }

  function guardarBorradorTripoEncargo() {
    try {
      if (!encargoState?.tripoTaskId) return;
      window.localStorage?.setItem(ENCARGOS_TRIPO_DRAFT_KEY, JSON.stringify({
        savedAt: Date.now(),
        email: encargoState.email || '',
        imageDataUrl: encargoState.imageDataUrl || '',
        conceptualPrompt: encargoState.conceptualPrompt || '',
        indicaciones: encargoState.indicaciones || '',
        tripoTaskId: encargoState.tripoTaskId || '',
        tripoStatus: encargoState.tripoStatus || '',
        tripoProgress: encargoState.tripoProgress || 0,
        tripoModelUrl: encargoState.tripoModelUrl || '',
        tripoRenderedImageUrl: encargoState.tripoRenderedImageUrl || '',
        tripoFileToken: encargoState.tripoFileToken || '',
        tripoCreditsConsumed: encargoState.tripoCreditsConsumed || 0
      }));
    } catch (_) {}
  }

  function cargarBorradorTripoEncargo() {
    try {
      const raw = window.localStorage?.getItem(ENCARGOS_TRIPO_DRAFT_KEY);
      if (!raw) return {};
      const draft = JSON.parse(raw);
      if (!draft?.savedAt || Date.now() - Number(draft.savedAt) > 24 * 60 * 60 * 1000) {
        limpiarBorradorTripoEncargo();
        return {};
      }
      return {
        ...
        conceptualPrompt: draft.conceptualPrompt || '',
        indicaciones: draft.indicaciones || '',
        tripoTaskId: draft.tripoTaskId || '',
        tripoStatus: draft.tripoStatus || '',
        tripoProgress: Number(draft.tripoProgress) || 0,
        tripoModelUrl: draft.tripoModelUrl || '',
        tripoRenderedImageUrl: draft.tripoRenderedImageUrl || '',
        tripoFileToken: draft.tripoFileToken || '',
        tripoCreditsConsumed: Number(draft.tripoCreditsConsumed) || 0
      };
    } catch (_) {
      limpiarBorradorTripoEncargo();
      return {};
  ...
  function limpiarBorradorTripoEncargo() {
    try {
      window.localStorage?.removeItem(ENCARGOS_TRIPO_DRAFT_KEY);
    } catch (_) {}
  }

  function restaurarBorradorEncargo(root) {
    if (!root || !encargoState.tripoTaskId) return;
    const emailInput = root.querySelector('#encargo-email');
    const indicacionesInput = root.querySelector('#encargo-indicaciones');
    const btn = root.querySelector('#encargo-preview-btn');
    if (emailInput && encargoState.email) emailInput.value = encargoState.email;
    if (indicacionesInput && encargoState.indicaciones) indicacionesInput.value = encargoState.indicaciones;
    if (encargoState.imageDataUrl) {
      setFrameImage(root.querySelector('#encargo-upload-preview'), encargoState.imageDataUrl, 'Imagen subida');
    }
    if (encargoState.tripoStatus === 'success' && encargoState.tripoModelUrl) {
      setFrameModel(root.querySelector('#encargo-preview-frame'), encargoState.tripoModelUrl, encargoState.tripoRenderedImageUrl);
      setEncargoStatus(root, 2, 'Modelo 3D listo. Puedes continuar con las opciones.');
      mostrarPasoEncargo(3);
      return;
    }
    if (btn) btn.textContent = 'Consultar estado del modelo';
    setFrameMessage(root.querySelector('#encargo-preview-frame'), 'Modelo 3D en proceso', 'Hay una generacion de Tripo en curso. Consulta el estado con el mismo boton para no gastar otra generacion.');
    setEncargoStatus(root, 2, 'Hay un modelo de Tripo en proceso. Consulta el estado sin volver a cargar la imagen.');
    mostrarPasoEncargo(2);
  }

  async function esperarModeloTripo(root, taskId) {
    const frame = root.querySelector('#encargo-preview-frame');
    const maxAttempts = 180;
    const delayMs = 3000;

    for (let intento = 0; intento < maxAttempts; intento += 1) {
      ...
      setEncargoStatus(root, 2, `Tripo sigue construyendo el modelo${progress}. Puedes dejar esta pagina abierta.`);
      setFrameMessage(frame, 'Modelo 3D en proceso', `Tripo esta generando la pieza preliminar${progress}. Esto puede tardar varios minutos segun la complejidad de la imagen.`);
    ...
    throw crearErrorTripoPendiente('El modelo sigue procesandose en Tripo. Puedes dejar esta pagina abierta o consultar el estado de nuevo con este mismo boton; no se crea otra generacion.');
  }

  async function prepararBaseEncargo(root, options = {}) {
    const allowPendingTask = options.allowPendingTask !== false;
    ...
    const tareaPendienteExistente = Boolean(allowPendingTask && encargoState.tripoTaskId && tripoEstaPendiente(encargoState.tripoStatus));

    if (!SONDEO_EMAIL_RE.test(email)) {
      setEncargoStatus(root, 2, 'Vuelve al paso 1 y confirma tu email.', true);
      return null;
    }
    if (!file && !encargoState.imageDataUrl && !tareaPendienteExistente) {
      setEncargoStatus(root, 2, 'Sube una imagen antes de continuar.', true);
      return null;
    }
    ...
    encargoState.email = email;
    encargoState.indicaciones = indicaciones;
    encargoState.conceptualPrompt = encargoState.conceptualPrompt || indicaciones;

    if (!encargoState.imageDataUrl && file) {
      try {
        encargoState.imageDataUrl = await comprimirImagenEncargo(file);
        setFrameImage(root.querySelector('#encargo-upload-preview'), encargoState.imageDataUrl, 'Imagen subida');
      } catch (_) {
    ...
    return { email, file, indicaciones, tareaPendienteExistente };
  }

  async function continuarEncargoManual(root) {
    const base = await prepararBaseEncargo(root, { allowPendingTask: true });
    if (!base) return;

    encargoState.tripoStatus = encargoState.tripoStatus || 'manual_review';
    setFrameMessage(root.querySelector('#encargo-preview-frame'), 'Revision manual', 'No hace falta que el modelo sea perfecto para pedir la cotizacion. Usaremos tu imagen, el sujeto indicado y tus ajustes para revisar viabilidad y precio.');
    setEncargoStatus(root, 2, 'Continuas sin modelo generado. Revisaremos la pieza manualmente antes de cotizar.');
    trackSimio('encargos_manual_continue', 'encargos', {
      source: 'manual_fallback',
      has_task: Boolean(encargoState.tripoTaskId),
  ...
  async function generarPreviewEncargo(root) {
    ...
    const base = await prepararBaseEncargo(root, { allowPendingTask: true });
    if (!base) return;
    const { email, file, indicaciones, tareaPendienteExistente } = base;

    const previousLabel = btn?.textContent || 'Generar modelo 3D';
    let mantenerConsultaPendiente = false;

    btn.disabled = true;
    btn.textContent = tareaPendienteExistente ? 'Consultando modelo...' : 'Generando modelo...';
    setEncargoStatus(root, 2, tareaPendienteExistente ? 'Consultando la tarea existente de Tripo...' : 'Generando modelo 3D con Tripo. Puede tardar varios minutos...');
    ...
    trackSimio('encargos_preview_started', 'encargos', {
      source: tareaPendienteExistente ? 'existing_task' : 'tripo3d',
      has_existing_task: tareaPendienteExistente,
      status: encargoState.tripoStatus || ''
    });
    ...
    try {
      ...
      if (!tareaPendienteExistente) {
        ...
        if (!response.ok && response.status !== 202) throw new Error(data.message || 'No pudimos generar el modelo 3D.');
      ...
      if (error.tripoPending) {
        mantenerConsultaPendiente = true;
        setFrameMessage(root.querySelector('#encargo-preview-frame'), 'Modelo 3D en proceso', error.message || 'Tripo sigue trabajando en esta pieza.');
        setEncargoStatus(root, 2, error.message || 'Tripo sigue trabajando en esta pieza.');
        trackSimio('encargos_preview_pending', 'encargos', {
      ...
      trackSimio('encargos_preview_failed', 'encargos', {
        source: 'tripo3d',
      ...
      btn.disabled = false;
      btn.textContent = mantenerConsultaPendiente ? 'Consultar estado del modelo' : previousLabel;
    }
  }
  ...
  async function enviarSolicitudEncargo(root) {
    ...
    const finalObservaciones = root.querySelector('#encargo-observaciones')?.value.trim() || '';
    const modelNotes = options.modelNotes || '';
    const observaciones = finalObservaciones.slice(0, 900);
    const payload = {
	        ...
	        variantsWrap.appendChild(figure);
			    ...
			    if (interestBlock) {
			      ...
			      if (checkoutForm) {
			        ...
			        prepararCheckoutInternacional(checkoutForm, item.checkoutSlug);
			      }
			      if (checkoutSubmit) {
			        checkoutSubmit.hidden = false;
			        checkoutSubmit.disabled = false;
			        checkoutSubmit.textContent = esCheckoutInternacional(item.checkoutSlug) ? t('checkout.internationalButton') : t('checkout.button');
  ...
  function poblarModalPartyAnimal(slug) {
    ...
    const imageCaption = modal.querySelector('[data-party-caption]');
    if (imageCaption) {
      if (item.caption) {
        imageCaption.removeAttribute('data-i18n');
        imageCaption.textContent = item.caption;
      } else {
        imageCaption.dataset.i18n = 'media.partyIllustration';
        imageCaption.textContent = t('media.partyIllustration');
      }
    }
  ...
  function poblarModalSimiug(slug) {
    ...
    const setText = (selector, value) => {
      ...
      if (el) el.textContent = value;
	    ...
	    setText('.estado-badge', item.state || t('state.simiugGestando'));
	    setText('[data-simiug-state]', item.state || t('state.simiugGestando'));
    ...
    setText('.producto-media-principal figcaption', item.mediaCaption || t('media.simiugIllustration'));
  ...
  document.addEventListener('keydown', function(e) {
    if (e.key === 'Escape') cerrarModal();
	  ...
	  const SONDEO_ENDPOINT = 'https://api.simioplateado.com/api/sondeo';
		  ...
		  const SHIPPING_COST_ENDPOINT = 'https://api.simioplateado.com/api/shipping-cost';
		  const INTERNATIONAL_QUOTE_ENDPOINT = 'https://api.simioplateado.com/api/international-quote';
	  ...
	  const CHECKOUT_COUNTRIES = [
	    { code: 'CO', name: 'Colombia', includedAddonUsd: 0 },
	    { code: 'US', name: 'Estados Unidos', includedAddonUsd: 70 },
	    { code: 'MX', name: 'México', includedAddonUsd: 70 },
	    { code: 'CA', name: 'Canadá', includedAddonUsd: 80 },
	    { code: 'ES', name: 'España', includedAddonUsd: 110 },
	    { code: 'FR', name: 'Francia', includedAddonUsd: 110 },
	    { code: 'DE', name: 'Alemania', includedAddonUsd: 110 },
	    { code: 'IT', name: 'Italia', includedAddonUsd: 110 },
	    { code: 'NL', name: 'Países Bajos', includedAddonUsd: 110 },
	    { code: 'CL', name: 'Chile', includedAddonUsd: 65 },
	    { code: 'PE', name: 'Perú', includedAddonUsd: 65 },
	    { code: 'EC', name: 'Ecuador', includedAddonUsd: 60 },
	    { code: 'PA', name: 'Panamá', includedAddonUsd: 60 }
	  ];
	  const CHECKOUT_COUNTRY_CODES = CHECKOUT_COUNTRIES.map(country => country.code);
	  const CHECKOUT_USD_TO_COP_REFERENCE = 4150;
  ...
  const CHECKOUT_PRODUCTS_FRONT = {
    'camiseta-blanca': { name: 'CAMISETA_BLANCA', priceCop: 81600, priceUsd: 20.4, modalSlug: 'wearables/camiseta-blanca', category: 'wearables' },
    'camiseta-negra': { name: 'CAMISETA_NEGRA', priceCop: 91200, priceUsd: 22.8, modalSlug: 'wearables/camiseta-negra', category: 'wearables' },
    gorra: { name: 'GORRA', priceCop: 105600, priceUsd: 26.4, modalSlug: 'wearables/gorra', category: 'wearables' },
	    marxito: { name: 'MARXITO.v01', priceCop: 250000, priceUsd: 63, modalSlug: 'marxito', category: 'figuras' },
	    traumin: { name: 'TRAUMIN.v01', priceCop: 220000, priceUsd: 55, modalSlug: 'traumin', category: 'figuras' },
	    superhombresito: { name: 'NIETZSCHESITO.v01', priceCop: 230000, priceUsd: 58, modalSlug: 'superhombresito', category: 'figuras' },
				    cthulito: { name: 'CTHULITO.v01', priceCop: 300000, priceUsd: 75, modalSlug: 'cthulito', category: 'figuras' },
				    quijotico: { name: 'QUIJOTICO.v01', priceCop: 260000, priceUsd: 65, modalSlug: 'quijotico', category: 'figuras' },
				    gabito: { name: 'GABITO.v01', priceCop: 240000, priceUsd: 60, modalSlug: 'gabito', category: 'figuras' },
			    poesito: { name: 'POESITO.v01', priceCop: 230000, priceUsd: 58, modalSlug: 'poesito', category: 'figuras' },
		    dostoiecito: { name: 'MINI_FIODOR.v01', priceCop: 230000, priceUsd: 58, modalSlug: 'mini-fiodor', category: 'figuras' },
		    acefalo: { name: 'ACEFALO.v01', priceCop: 200000, priceUsd: 50, modalSlug: 'acefalo', category: 'objetos' },
		    jarron: { name: 'KRAKEN_FLORERO.v01', priceCop: 220000, priceUsd: 55, modalSlug: 'jarron', category: 'objetos' },
		    'coleccion-feli': { name: 'COLECCION_FELI.v01', priceCop: 400000, priceUsd: 100, modalSlug: 'coleccion-feli', category: 'objetos' },
		    'venus-feli': { name: 'VENUS_FELI.v01', priceCop: 150000, priceUsd: 37.5, modalSlug: 'venus-feli', category: 'objetos' },
		    'pensador-feli': { name: 'PENSADOR_FELI.v01', priceCop: 180000, priceUsd: 45, modalSlug: 'pensador-feli', category: 'objetos' },
		    'david-feli': { name: 'DAVID_FELI.v01', priceCop: 150000, priceUsd: 37.5, modalSlug: 'david-feli', category: 'objetos' },
		    'sphinx-tenebrosa': { name: 'PA-002 · SPHINX TENEBROSA', priceCop: 250000, priceUsd: 63, modalSlug: 'sphinx-tenebrosa', category: 'objetos' }
	  };
  ...
  function normalizarPaisCheckout(value) {
    const raw = String(value || '').trim();
    if (!raw) return 'CO';
    const upper = raw.normalize('NFD').replace(/[\u0300-\u036f]/g, '').toUpperCase();
    if (CHECKOUT_COUNTRY_CODES.includes(upper)) return upper;
    const aliases = {
      COLOMBIA: 'CO',
      'ESTADOS UNIDOS': 'US',
      'UNITED STATES': 'US',
    ...
    return aliases[upper] || 'CO';
  }

  function paisCheckout(code) {
    return CHECKOUT_COUNTRIES.find(country => country.code === normalizarPaisCheckout(code)) || CHECKOUT_COUNTRIES[0];
  }

  function formatearCopCheckout(value) {
    return 'COP ' + Math.round(Number(value) || 0).toLocaleString('es-CO');
  }

  function precioUsdCheckout(product) {
    const explicit = Number(product?.priceUsd);
    if (Number.isFinite(explicit) && explicit > 0) return explicit;
    return Number(((Number(product?.priceCop) || 0) / CHECKOUT_USD_TO_COP_REFERENCE).toFixed(2));
  }

  function formatearUsdCheckout(value) {
  ...
  function esCheckoutInternacional(slug) {
    const code = normalizarPaisCheckout(campoCheckout(slug, 'pais')?.value);
    return Boolean(code && code !== 'CO');
  }
  ...
  function leerUltimoCheckout() {
    try {
	  ...
	  function prepararCheckoutInternacional(form, slug) {
	    const product = productoCheckout(slug);
	    if (!form || !product) return;
	    form.dataset.checkoutFormSlug = product.slug;

	    let countryField = campoCheckout(product.slug, 'pais') || form.querySelector('[data-literato-checkout-field="pais"]');
	    if (!countryField) return;

	    const selectedCountry = normalizarPaisCheckout(countryField.value);
	    if (countryField.tagName !== 'SELECT') {
	      const select = document.createElement('select');
	      select.id = 'checkout-pais-' + product.slug;
	      select.dataset.checkoutCountry = product.slug;
	      select.setAttribute('autocomplete', 'country-name');
	      if (countryField.dataset.literatoCheckoutField) select.dataset.literatoCheckoutField = 'pais';
	      countryField.replaceWith(select);
	      countryField = select;
	    } else {
	      countryField.id = 'checkout-pais-' + product.slug;
	      countryField.dataset.checkoutCountry = product.slug;
	    }

	    if (!countryField.options.length || countryField.options.length !== CHECKOUT_COUNTRIES.length) {
	      countryField.innerHTML = CHECKOUT_COUNTRIES.map(country => (
	        '<option value="' + country.code + '">' + escapeHtml(country.name) + '</option>'
	      )).join('');
	    }
	    countryField.value = selectedCountry;

	    if (countryField.dataset.countryModeReady !== 'true') {
	      countryField.dataset.countryModeReady = 'true';
	      countryField.addEventListener('change', () => {
	        limpiarErrorCampoCheckout(countryField);
	        actualizarModoCheckout(product.slug, { track: true });
	      });
	    }

	    let note = document.getElementById('checkout-shipping-note-' + product.slug);
	    if (!note) {
	      note = document.createElement('div');
	      note.className = 'checkout-shipping-note';
	      note.id = 'checkout-shipping-note-' + product.slug;
	      note.setAttribute('aria-live', 'polite');
	      const row = countryField.closest('.checkout-pair') || countryField.closest('label') || form.querySelector('.checkout-fields');
	      row?.insertAdjacentElement('afterend', note);
	    }

	    actualizarModoCheckout(product.slug);
	  }

	  function inicializarCheckoutInternacional() {
	    Object.keys(CHECKOUT_PRODUCTS_FRONT).forEach(slug => {
	      const form = formCheckout(slug);
	      if (form) prepararCheckoutInternacional(form, slug);
	    });
	  }

	  function actualizarModoCheckout(slug, options = {}) {
	    const product = productoCheckout(slug);
	    const form = formCheckout(slug);
	    if (!product || !form) return;
	    const country = paisCheckout(campoCheckout(product.slug, 'pais')?.value);
	    const isInternational = country.code !== 'CO';
	    const note = document.getElementById('checkout-shipping-note-' + product.slug);
	    const submit = form.querySelector('[data-literato-checkout-submit]') || form.querySelector('.submit');
	    const postal = campoCheckout(product.slug, 'postal');

	    if (submit && !submit.disabled) {
	      submit.textContent = isInternational ? t('checkout.internationalButton') : t('checkout.button');
	    }
	    if (postal) {
	      postal.closest('label')?.querySelector('span')?.replaceChildren(
	        document.createTextNode(isInternational ? t('checkout.postalLabelRequired') : t('checkout.postalLabel'))
	      );
	    }
	    if (note) {
	      if (isInternational) {
	        const totalUsd = Number((precioUsdCheckout(product) + (Number(country.includedAddonUsd) || 0)).toFixed(2));
	        const totalCop = Math.round(totalUsd * CHECKOUT_USD_TO_COP_REFERENCE);
	        note.innerHTML = [
	          '<strong>' + escapeHtml(t('checkout.internationalNoteTitle')) + '</strong>',
	          '<span>' + escapeHtml(
	            t('checkout.internationalNote')
	              .replace('{country}', country.name)
	              .replace('{usd}', formatearUsdCheckout(totalUsd))
	              .replace('{total}', formatearCopCheckout(totalCop))
	          ) + '</span>',
	          '<small>' + escapeHtml(t('checkout.internationalDdu')) + '</small>'
	        ].join('');
	        if (options.track) {
	          trackSimio('shipping_cost_viewed', product.slug, {
	            country: country.code,
	            included_total_usd: totalUsd
	          });
	        }
	      } else {
	        note.innerHTML = [
	          '<strong>' + escapeHtml(t('checkout.domesticNoteTitle')) + '</strong>',
	          '<span>' + escapeHtml(t('checkout.domesticNote')) + '</span>'
	        ].join('');
	      }
	    }
	  }
	  ...
	  function validarCheckoutForm(slug, options = {}) {
	    ...
	    const countryCode = normalizarPaisCheckout(campoCheckout(product.slug, 'pais')?.value);
	    if (countryCode !== 'CO') {
	      const postalField = campoCheckout(product.slug, 'postal');
	      if (!(postalField?.value || '').trim()) {
	        invalid.push({ field: postalField, message: t('checkout.postalRequired') });
	      }
	    }
  ...
  const I18N = {
    es: {
      ...
      'store.shippingIncludedTitle': 'Colombia: envío incluido',
      'store.shippingIncludedCopy': 'Los precios publicados de compra directa ya incluyen envío nacional. En las piezas empacadas, el valor contempla figura, estuche de colección e ilustración/tarjeta. Para exterior, mostramos un total internacional con envío incluido y confirmamos el definitivo por email antes de cobrar.',
      ...
      'filter.family.greatMinds': 'GRANDES/MENTES',
	      ...
	      'filter.family.panteonArgenti': 'PANTEÓN ARGENTI',
      ...
      'gallery.group.objects': 'Objetos físicos, recipientes, monstruos y piezas raras que ya piden escala propia.',
	      'gallery.group.panteonArgenti': 'Deidades, guardianes y ruinas ceremoniales del Panteón Argenti: Volumen I en producción.',
      ...
      'desc.capitanNauseaObject': 'náusea capitaneada',
		      ...
		      'desc.goticupFunctional': 'vaso funcional · acero inoxidable',
		      ...
		      'desc.vidaYPena': 'pieza física impresa · Fatum et Dolor',
      ...
      'essay.breadcrumb': 'Ensayo 001 / Manifiesto-video',
      ...
      'cyborg.breadcrumb': 'Publicación 002 / Documento visual-teórico',
      ...
      'about.contact': 'hablanos:',
	      ...
	      'buy.copy': 'Los productos disponibles se pagan por Mercado Pago. El envío nacional en Colombia está incluido. En las figuras que van empacadas, el valor no es solo la pieza: contempla estuche de colección, ilustración/tarjeta y preparación de despacho. Para compras fuera de Colombia, mostramos un total internacional con envío incluido y confirmamos el definitivo por email antes de cobrar. Las piezas en producción siguen como aviso de disponibilidad o pre-order cuando corresponda. Los precios disponibles se muestran en COP con referencia USD aproximada; el cobro se procesa en COP.',
	      'shipping.title': 'Envíos',
	      'shipping.includedShort': 'Incluye envío nacional en Colombia',
	      'shipping.copy': 'Enviamos desde Medellín, Colombia. En Colombia, el envío nacional está incluido. Para otros países, trabajamos con total internacional con envío incluido y coordinamos el total definitivo contigo por email o WhatsApp antes de cobrar. Las piezas se preparan como objetos de colección; cuando aplica, viajan en estuche con su gráfica/ilustración. Wearables: 7-14 días hábiles. Ediciones limitadas: se envían según disponibilidad y preparación de cada pieza.',
      ...
      'checkout.copy': 'Compra segura vía Mercado Pago. Tirada inicial de 10 unidades, intervenidas y terminadas a mano en Medellín. Cuando aplica, el valor contempla pieza, estuche de colección e ilustración/tarjeta. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
      'checkout.copySuperhombresito': 'Compra segura vía Mercado Pago. Figura FDM intervenida a mano, 17,5 cm alto x 10,5 cm ancho x 9 cm profundo. Tirada inicial de 10 unidades, intervenidas y terminadas a mano en Medellín. Cuando aplica, el valor contempla pieza, estuche de colección e ilustración/tarjeta. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
      'checkout.copyMarxito': 'Compra segura vía Mercado Pago. Figura FDM intervenida a mano, 18 cm alto x 12 cm ancho x 11 cm profundo. Tirada inicial de 10 unidades, intervenidas y terminadas a mano en Medellín. Cuando aplica, el valor contempla pieza, estuche de colección e ilustración/tarjeta. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
      'checkout.copyTraumin': 'Compra segura vía Mercado Pago. Figura FDM intervenida a mano, 18 cm alto x 11 cm ancho x 11 cm profundo. Tirada inicial de 10 unidades, intervenidas y terminadas a mano en Medellín. Cuando aplica, el valor contempla pieza, estuche de colección e ilustración/tarjeta. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
      ...
      'checkout.priceNoteTraumin': 'Precio: COP 220.000. Referencia aproximada: USD 55. Mercado Pago procesa el cobro en COP.',
	      'checkout.copyJarron': 'Compra segura vía Mercado Pago. Kraken Florero FDM intervenido a mano, 15,2 cm alto x 9,9 cm ancho x 10,3 cm profundo. Tirada inicial de 5 unidades, intervenidas y terminadas a mano en Medellín. Cuando aplica, el valor contempla pieza, estuche de colección e ilustración/tarjeta. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
	      'checkout.priceNoteJarron': 'Precio: COP 220.000. Referencia aproximada: USD 55. Mercado Pago procesa el cobro en COP.',
		      'checkout.copyCthulito': 'Compra segura vía Mercado Pago. CTHULITO.v01 FDM intervenido a mano, acabado dorado brillante, 11 cm alto x 18,5 cm ancho x 16,5 cm profundo. Tirada inicial de 3 unidades, intervenidas y terminadas a mano en Medellín. Cuando aplica, el valor contempla pieza, estuche de colección e ilustración/tarjeta. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
		      'checkout.priceNoteCthulito': 'Precio: COP 300.000. Referencia aproximada: USD 75. Mercado Pago procesa el cobro en COP.',
		      'checkout.copyQuijotico': 'Compra segura vía Mercado Pago. QUIJOTICO.v01 FDM intervenido a mano, acabado dorado brillante, con lanza fina y alto nivel de detalle. Medidas finales por confirmar antes de despacho. Cuando aplica, el valor contempla pieza, estuche de colección e ilustración/tarjeta. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
		      'checkout.priceNoteQuijotico': 'Precio: COP 260.000. Referencia aproximada: USD 65. Mercado Pago procesa el cobro en COP.',
	      'checkout.copyWearable': 'Compra segura vía Mercado Pago. Envío nacional incluido en Colombia. Para envíos internacionales, te mostramos un total con envío incluido y confirmamos el definitivo por email antes de cobrar.',
      ...
      'checkout.internationalButton': 'Solicitar cotización internacional',
      'checkout.internationalSending': 'Enviando solicitud internacional...',
      'checkout.internationalSuccess': 'Listo. Recibimos tu solicitud internacional. Te enviaremos por email el total definitivo con envío y link de pago.',
      'checkout.internationalError': 'No pudimos registrar la cotización internacional. Intenta de nuevo o escríbenos.',
      ...
      'checkout.countryLabel': 'País',
	      ...
	      'checkout.postalLabelRequired': 'Código postal',
	      ...
	      'checkout.postalRequired': 'El código postal es necesario para confirmar totales internacionales.',
	      ...
	      'checkout.domesticNoteTitle': 'Colombia',
	      'checkout.domesticNote': 'Envío nacional incluido. Puedes pagar ahora con Mercado Pago.',
	      'checkout.internationalNoteTitle': 'Total internacional con envío incluido',
	      'checkout.internationalNote': '{country}: total preliminar {usd} / {total} aprox., con envío incluido. Confirmamos el total definitivo por email antes de cobrar.',
	      'checkout.internationalDdu': 'Aranceles, impuestos o gastos de importación en destino pueden aplicar según cada país.',
    ...
    en: {
      ...
      'store.shippingIncludedTitle': 'Colombia: shipping included',
      'store.shippingIncludedCopy': 'Published direct-purchase prices already include domestic shipping in Colombia. For boxed pieces, the value covers the figure, collection case, and illustration/card. For international orders, we show a total with shipping included and confirm the final amount by email before charging.',
      ...
      'filter.family.greatMinds': 'GREAT/MINDS',
	      ...
	      'filter.family.panteonArgenti': 'PANTEON ARGENTI',
      ...
      'gallery.group.objects': 'Physical objects, vessels, monsters, and odd pieces already asking for their own scale.',
	      'gallery.group.panteonArgenti': 'Deities, guardians, and ceremonial ruins from Panteon Argenti: Volume I in production.',
      ...
      'state.printingTest': 'In production · real printed piece',
	      'state.partyAnimalGestando': 'In gestation · 3D model ready',
	      'state.simiugGestando': 'In gestation · object prototype',
	      'state.simiugFunctional': 'Real prototype · functional cup',
      ...
      'desc.capitanNauseaObject': 'captained nausea',
		      ...
		      'desc.goticupFunctional': 'functional cup · stainless steel',
		      ...
		      'desc.vidaYPena': 'real printed piece · Fatum et Dolor',
      ...
      'essay.breadcrumb': 'Essay 001 / Manifesto-video',
      ...
      'cyborg.breadcrumb': 'Publication 002 / Visual-theoretical document',
      ...
      'buy.copy': 'Available products are paid through Mercado Pago. Domestic shipping in Colombia is included. For boxed figures, the value is not only the figure: it covers the collection case, illustration/card, and dispatch preparation. For purchases outside Colombia, we show an international total with shipping included and confirm the final amount by email before charging. Pieces in production remain as availability notices or pre-order when applicable. Available prices are shown in COP with approximate USD references.',
      'shipping.title': 'Shipping',
      'shipping.includedShort': 'Domestic shipping included in Colombia',
      'shipping.copy': 'Ships from Medellín, Colombia. Domestic shipping in Colombia is included. For other countries, we work with an international total with shipping included and coordinate the final amount with you by email or WhatsApp before charging. Pieces are prepared as collectible objects; when applicable, they travel in a case with their graphic/illustration. Wearables: 7-14 business days. Limited editions ship according to availability and hand-finishing time.',
      ...
      'checkout.copy': 'Secure payment through Mercado Pago. Initial run of 10 units, hand-finished in Medellín. When applicable, the value covers the piece, collection case, and illustration/card. Domestic shipping in Colombia is included. For international orders, we show a total with shipping included and confirm the final amount by email before charging.',
      'checkout.copySuperhombresito': 'Secure payment through Mercado Pago. Hand-finished FDM figure, 17.5 cm high x 10.5 cm wide x 9 cm deep. Initial run of 10 units, hand-finished in Medellín. When applicable, the value covers the piece, collection case, and illustration/card. Domestic shipping in Colombia is included. For international orders, we show a total with shipping included and confirm the final amount by email before charging.',
      'checkout.copyMarxito': 'Secure payment through Mercado Pago. Hand-finished FDM figure, 18 cm high x 12 cm wide x 11 cm deep. Initial run of 10 units, hand-finished in Medellín. When applicable, the value covers the piece, collection case, and illustration/card. Domestic shipping in Colombia is included. For international orders, we show a total with shipping included and confirm the final amount by email before charging.',
      'checkout.copyTraumin': 'Secure payment through Mercado Pago. Hand-finished FDM figure, 18 cm high x 11 cm wide x 11 cm deep. Initial run of 10 units, hand-finished in Medellín. When applicable, the value covers the piece, collection case, and illustration/card. Domestic shipping in Colombia is included. For international orders, we show a total with shipping included and confirm the final amount by email before charging.',
      ...
      'checkout.priceNoteTraumin': 'Price: COP 220,000. Approx. USD 55 reference. Mercado Pago charges in COP.',
	      'checkout.copyJarron': 'Secure payment through Mercado Pago. Hand-finished Kraken Florero FDM object, 15.2 cm high x 9.9 cm wide x 10.3 cm deep. Initial run of 5 units, hand-finished in Medellín. When applicable, the value covers the piece, collection case, and illustration/card. Domestic shipping in Colombia is included. For international orders, we show a total with shipping included and confirm the final amount by email before charging.',
	      'checkout.priceNoteJarron': 'Price: COP 220,000. Approx. USD 55 reference. Mercado Pago charges in COP.',
		      'checkout.copyCthulito': 'Secure payment through Mercado Pago. Hand-finished CTHULITO.v01 FDM piece, glossy gold finish, 11 cm high x 18.5 cm wide x 16.5 cm deep. Initial run of 3 units, hand-finished in Medellín. When applicable, the value covers the piece, collection case, and illustration/card. Domestic shipping in Colombia is included. For international orders, we show a total with shipping included and confirm the final amount by email before charging.',
		      'checkout.priceNoteCthulito': 'Price: COP 300,000. Approx. USD 75 reference. Mercado Pago charges in COP.',
		      'checkout.copyQuijotico': 'Secure payment through Mercado Pago. Hand-finished QUIJOTICO.v01 FDM piece, glossy gold finish, fine lance and high detail level. Final dimensions will be confirmed before dispatch. When applicable, the value covers the piece, collection case, and illustration/card. Domestic shipping in Colombia is included. For international orders, we show a total with shipping included and confirm the final amount by email before charging.',
		      'checkout.priceNoteQuijotico': 'Price: COP 260,000. Approx. USD 65 reference. Mercado Pago charges in COP.',
	      'checkout.copyWearable': 'Secure payment through Mercado Pago. Domestic shipping in Colombia is included. For international orders, we show a total with shipping included and confirm the final amount by email before charging.',
      ...
      'checkout.internationalButton': 'Request international quote',
      'checkout.internationalSending': 'Sending international request...',
      'checkout.internationalSuccess': 'Done. We received your international request. We will email the final total with shipping and payment link.',
      'checkout.internationalError': 'We could not save the international quote request. Please try again or contact us.',
      ...
      'checkout.countryLabel': 'Country',
	      ...
	      'checkout.postalLabelRequired': 'Postal code',
	      'checkout.postalPlaceholder': '050001',
	      ...
	      'checkout.postalRequired': 'Postal code is required to confirm international totals.',
	      ...
	      'checkout.domesticNoteTitle': 'Colombia',
	      'checkout.domesticNote': 'Domestic shipping is included. You can pay now with Mercado Pago.',
	      'checkout.internationalNoteTitle': 'International total with shipping included',
	      'checkout.internationalNote': '{country}: preliminary total {usd} / {total} approx., shipping included. We confirm the final total by email before charging.',
	      'checkout.internationalDdu': 'Import duties, taxes, or destination fees may apply depending on the country.',
  ...
  const COMMERCIAL_TEXT_KEYS = {
    ...
    'Available · checkout open': 'state.buyOpen',
	    ...
	    'pieza física impresa · Fatum et Dolor': 'desc.vidaYPena',
	    'real printed piece · Fatum et Dolor': 'desc.vidaYPena',
    'Gestándose · prototipo de objeto': 'state.simiugGestando',
    'In gestation · object prototype': 'state.simiugGestando',
    'Prototipo real · vaso funcional': 'state.simiugFunctional',
    'Real prototype · functional cup': 'state.simiugFunctional',
	    'objeto conceptual · taza/recipiente': 'desc.simiugDigital',
	    'concept object · cup/vessel': 'desc.simiugDigital',
	    'vaso funcional · acero inoxidable': 'desc.goticupFunctional',
	    'functional cup · stainless steel': 'desc.goticupFunctional',
  ...
  function aplicarIdioma(lang) {
    ...
    document.querySelectorAll('[data-lang-switch]').forEach(btn => {
      btn.classList.toggle('activo', btn.dataset.langSwitch === currentLang);
	    ...
	    inicializarCheckoutInternacional();
  ...
  async function votarSilencio(panelId, confId, btnId) {
    ...
    btn.textContent = t('button.thanks');
	  ...
	  async function iniciarCompra(event, slug, source = 'checkout_form') {
	    ...
	    limpiarCheckoutIssueWidget(slug);
		    ...
		    const isInternational = orderData.shipping.country_code && orderData.shipping.country_code !== 'CO';

		    if (isInternational) {
		      await solicitarCotizacionInternacional({ slug, source, orderData, btn, status, originalText });
		      return;
		    }
    ...
    try {
	  ...
	  async function solicitarCotizacionInternacional({ slug, source, orderData, btn, status, originalText }) {
	    if (btn) {
	      btn.textContent = t('checkout.internationalSending');
	      btn.disabled = true;
	    }

	    trackEventoComercioCustom('InternationalQuoteStarted', slug, {
	      source,
	      country: orderData.shipping.country_code
	    });
	    trackSimio('international_quote_started', slug, {
	      source,
	      country: orderData.shipping.country_code
	    });

	    try {
	      const resp = await fetch(INTERNATIONAL_QUOTE_ENDPOINT, {
	        method: 'POST',
	        headers: { 'Content-Type': 'application/json' },
	        body: JSON.stringify({
	          slug,
	      ...
	      if (!resp.ok || !data.ok) {
	        throw new Error(data.message || t('checkout.internationalError'));
	      }

	      if (status) {
	        status.textContent = t('checkout.internationalSuccess');
	        status.classList.add('ok');
	      }
	      trackEventoComercioCustom('InternationalQuoteRequested', slug, {
	        source,
	        country: orderData.shipping.country_code
	      });
	      trackSimio('international_quote_requested', slug, {
	        source,
	        country: orderData.shipping.country_code,
	        order_id: data.order_id || null
	      });
	      if (btn) {
	        btn.textContent = t('checkout.internationalButton');
	        btn.disabled = false;
	      }
	    } catch (err) {
	      trackEventoComercioCustom('InternationalQuoteError', slug, {
	        source,
	        country: orderData.shipping.country_code,
	        message: err.message || 'international_quote_error'
	      });
	      trackSimio('international_quote_error', slug, {
	        source,
	        country: orderData.shipping.country_code,
	        message: err.message || 'international_quote_error'
	      });
	      if (status) {
	        status.textContent = err.message || t('checkout.internationalError');
	        status.classList.add('error');
	      }
	      if (btn) {
	        btn.textContent = originalText || t('checkout.internationalButton');
	        btn.disabled = false;
	      }
	    }
	  }
  ...
  function leerDatosCheckout(slug) {
    ...
    const country = paisCheckout(valor('pais'));
