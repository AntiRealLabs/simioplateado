  ...
  async function esperarModeloTripo(root, taskId) {
    ...
    throw crearErrorTripoPendiente('El modelo sigue procesandose en Tripo. Puedes consultar el estado de nuevo con este mismo boton; no se crea otra generacion.');
  }
