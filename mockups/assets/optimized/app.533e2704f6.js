  ...
  const I18N = {
    es: {
      ...
      'checkout.countryLabel': 'País',
	      ...
	      'checkout.internationalNote': '{country}: referencia de envío {usd} ({cop} aprox.). Confirmamos el total definitivo por email antes de cobrar.',
    ...
    en: {
      ...
      'checkout.countryLabel': 'Country',
	      ...
	      'checkout.internationalNote': '{country}: shipping reference {usd} ({cop} approx.). We confirm the final total by email before charging.',
